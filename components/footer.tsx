    ...
    <footer className="relative z-10 bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex gap-5">
                  ...
                  >
                    <Instagram className="w-6 h-6 text-pink-500 hover:scale-110 hover:text-pink-400 transition-all" />
                  </a>
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <Linkedin className="w-6 h-6 text-blue-500 hover:scale-110 hover:text-blue-400 transition-all" />
                  </a>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Sonic Chess Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
